...
export default function AppDownload() {
  return (
    <div className="flex items-center justify-center mb-10">
      <div>
        <div className="flex flex-col w-full gap-2 p-1 md:flex-row">
          <a
            href=""
            target="_blank"
            className="flex items-center justify-center w-full px-3 py-2 text-center text-black border border-black rounded-lg"
            rel="noreferrer"
          >
            <svg
              className="w-5"
